...
p1.normal <- p1.normal + geom_line() + geom_line(data = returns-df.normal$residuals, colour = "red")
...
p1.t <- p1.t + geom_line() + geom_line(data = returns-df.t$residuals, colour = "red")
...
p1.GED <- p1.GED + geom_line() + geom_line(data = returns-df.GED$residuals, colour = "red")
...
p1.PED <- p1.PED + geom_line() + geom_line(data = returns-df.PED$residuals, colour = "red")
